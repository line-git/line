...
int main(int argc, char *argv[])
{
  ...
  print_result(logfptr, precision, sol_eps_ord_wrt_cmp, MI_wrt_cmp, dim_wrt_cmp, order, nloops);
  ...
  if (filepath_result) {
    ...
    print_result(resfptr, precision, sol_eps_ord_wrt_cmp, MI_wrt_cmp, dim_wrt_cmp, order, nloops);
    fclose(resfptr);
  }
